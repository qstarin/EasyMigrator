...
namespace EasyMigrator.Extensions
{
    ...
    static public class NullableExtensions
    {
        ...
        static public void IfHasValue<T>(this T? obj, Action<T> then)
            where T : struct
        {
            if (obj.HasValue)
                then(obj.Value);
        ...
        static public TResult IfHasValue<T, TResult>(this T? obj, Func<T, TResult> then)
            where T : struct
        {
        ...
        static public TResult IfHasValue<T, TResult>(this T? obj, Func<T, TResult> then, TResult otherwise)
            where T : struct
        {
        ...
        static public TResult IfHasValue<T, TResult>(this T? obj, Func<T, TResult> then, Func<TResult> otherwise)
            where T : struct
        {
            return obj.HasValue ? then(obj.Value) : otherwise();
        }
        ...
        static public T IfNotHasValue<T>(this T? obj, T then)
            where T : struct
        {
        ...
        static public T IfNotHasValue<T>(this T? obj, Func<T> then)
            where T : struct
        {
            return obj.HasValue ? obj.Value : then();
        }
